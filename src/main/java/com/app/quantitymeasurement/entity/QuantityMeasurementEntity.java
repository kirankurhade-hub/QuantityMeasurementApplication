...
public class QuantityMeasurementEntity implements Serializable {
	...
	public void setThisValue(double v) {
		this.thisValue = v;
	}
	...
	public void setThisUnit(String v) {
		this.thisUnit = v;
	}
	...
	public void setThisMeasurementType(String v) {
		this.thisMeasurementType = v;
	}
	...
	public void setThatValue(double v) {
		this.thatValue = v;
	}
	...
	public void setThatUnit(String v) {
		this.thatUnit = v;
	}
	...
	public void setThatMeasurementType(String v) {
		this.thatMeasurementType = v;
	}
	...
	public void setResultUnit(String v) {
		this.resultUnit = v;
	}
	...
	public void setResultMeasurementType(String v) {
		this.resultMeasurementType = v;
	}
	...
	public void setResultString(String v) {
		this.resultString = v;
	}
	...
	public boolean equals(Object obj) {
		...
		return Double.compare(thisValue, other.thisValue) == 0 && Double.compare(thatValue, other.thatValue) == 0
				...
				&& Objects.equals(operation, other.operation) && Objects.equals(resultString, other.resultString)
				&& Double.compare(resultValue, other.resultValue) == 0 && isError == other.isError
				&& Objects.equals(errorMessage, other.errorMessage);
	}

	@Override
	public int hashCode() {
		return Objects.hash(thisValue, thisUnit, thisMeasurementType, thatValue, thatUnit, thatMeasurementType,
				operation, resultValue, resultUnit, resultMeasurementType, resultString, isError, errorMessage);
	}

	@Override
	public String toString() {
		if (isError)
			return String.format("[%s] %.1f %s + %.1f %s | ERROR: %s", operation, thisValue, thisUnit, thatValue,
					thatUnit, errorMessage);
		if (resultString != null)
			return String.format("[%s] %.1f %s == %.1f %s | Result: %s", operation, thisValue, thisUnit, thatValue,
					thatUnit, resultString);
		return String.format("[%s] %.1f %s + %.1f %s | Result: %.2f %s", operation, thisValue, thisUnit, thatValue,
				thatUnit, resultValue, resultUnit);
	}
}
